...
- Exercise 2: E-commerce product search with linear and binary search.
- Exercise 3: Sorting customer orders by total price.
- Exercise 4: Employee management with array operations.
